...
alg_delta_set = delta_set.DeltaSet(delta_times_us,"1.0e6")
...
var_duration_alg_exp_tsk = exp_task.ExperimentTask(ALGORITHM,alg_params,task_set,alg_delta_set,VERBOSE)
...
exp_runner_instance.run_experiments([var_duration_alg_exp_tsk],make_dbf_log_file,make_exp_log_file,make_agg_log_file,EXPERIMENT_NAME,VERBOSE)
