#Set Title
set title "Demand Calculation Peak RAM vs. Duration" font "Times, 12"
...
#Name PDF
set output "exp2-duration-p5-12-mem.pdf"

plot \
   '../../src/exp_data/var_duration-kavr24-p5-can-2.0e7-memo-1-slnSeq-0-trace-1-AG.csv'  every ::1::1 using 10:($11/1048576) with linespoints pt 9 lc rgb "web-green" title "CAN-KAVR-P05",\
    '../../src/exp_data/var_duration-kavr24-p5-gen-2.0e7-memo-1-slnSeq-0-trace-1-AG.csv'  every ::1::1 using 10:($11/1048576) with linespoints pt 8 lc rgb "blue" title "GEN-KAVR-P05",\
    '../../src/exp_data/var_duration-kavr24-p12-can-2.0e7-memo-1-slnSeq-0-trace-1-AG.csv'  every ::1::1 using 10:($11/1048576) with linespoints pt 9 lc rgb "web-green" title "CAN-KAVR-P12",\
    '../../src/exp_data/var_duration-kavr24-p12-gen-2.0e7-memo-1-slnSeq-0-trace-1-AG.csv'  every ::1::1 using 10:($11/1048576) with linespoints pt 8 lc rgb "blue" title "GEN-KAVR-P12",\
